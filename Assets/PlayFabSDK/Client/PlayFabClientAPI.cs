...
namespace PlayFab
{
    ...
    public static class PlayFabClientAPI
    {
        ...
        public static void GetAccountInfo(GetAccountInfoRequest request, Action onUpdateUserAccountInfosSuccess, Action onUpdateUserAccountInfosError)
        {
            throw new NotImplementedException();
        }

        public static void GetTitleNews(GetTitleNewsRequest getTitleNewsRequest, Action onGetTitleNewsSuccess, Action onGetTitleNewsError)
        {
            throw new NotImplementedException();
        }
    }
